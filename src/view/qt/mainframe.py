...
class Ui_frame_main(object):
    def setupUi(self, frame_main):
        ...
        self.button_startAppliction.setGeometry(QRect(450, 60, 231, 61))
        ...
        self.progressBar_tickers.setGeometry(QRect(490, 130, 221, 51))
    ...
    def retranslateUi(self, frame_main):
        ...
        self.progressBar_tickers.setFormat(QCoreApplication.translate("frame_main", u"Waiting for watchlist", None))
