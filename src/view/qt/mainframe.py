...
class Ui_frame_main(object):
    def setupUi(self, frame_main):
        ...
        self.button_genGraph.setGeometry(QRect(860, 50, 131, 81))
        self.tabWidget = QTabWidget(self.centralwidget)
        self.tabWidget.setObjectName(u"tabWidget")
        self.tabWidget.setGeometry(QRect(20, 20, 769, 770))
        ...
        self.table_watchlist.setGeometry(QRect(-1, -1, 765, 740))
        ...
        self.label_addTicker.setGeometry(QRect(860, 250, 131, 21))
        ...
        self.plainTextEdit_addTicker.setGeometry(QRect(850, 280, 151, 31))
        ...
        self.plainTextEdit_searchTicker.setGeometry(QRect(850, 200, 151, 31))
        self.label_searchTicker = QLabel(self.centralwidget)
        self.label_searchTicker.setObjectName(u"label_searchTicker")
        self.label_searchTicker.setGeometry(QRect(880, 170, 81, 16))
        self.comboBox_period = QComboBox(self.centralwidget)
        self.comboBox_period.setObjectName(u"comboBox_period")
        self.comboBox_period.setGeometry(QRect(840, 400, 181, 31))
        self.label_period = QLabel(self.centralwidget)
        self.label_period.setObjectName(u"label_period")
        self.label_period.setGeometry(QRect(890, 360, 81, 21))
        self.pushButton_importWatchlist = QPushButton(self.centralwidget)
        self.pushButton_importWatchlist.setObjectName(u"pushButton_importWatchlist")
        self.pushButton_importWatchlist.setGeometry(QRect(880, 570, 111, 41))
        self.label_watchlistpath = QLabel(self.centralwidget)
        self.label_watchlistpath.setObjectName(u"label_watchlistpath")
        self.label_watchlistpath.setGeometry(QRect(800, 630, 231, 191))
    ...
    def retranslateUi(self, frame_main):
        ...
        self.pushButton_importWatchlist.setText(QCoreApplication.translate("frame_main", u"import watchlist", None))
